<div x-data="{isOpen: false}">
  ...
  <div data-name="{{auth()->user()->name}}" data-avatar="{{auth()->user()->avatar}}" id="chat-wrapper"
    ...
    <div id="chat" class="chat-log">
      ...
      <div class="chat-other">
        <a href="/profile/{{$chat['name']}}"><img class="avatar-tiny" src="{{$chat['avatar']}}"></a>
        <div class="chat-message">
          <div class="chat-message-inner">
            <a href="/profile/{{$chat['name']}}"><strong>{{$chat['name']}}:</strong></a>
            {{$chat['textvalue']}}
          </div>
        </div>
      </div>
