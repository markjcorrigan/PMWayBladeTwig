                            ...
                            <div class="benefits">
                                ...
                                <div class="benefits__item flex gap-4 md:gap-2">
                                    ...
                                    <div class="benefits__item__content flex-1">
                                        ...
                                        <p
                                            class="benefits__item__description text-xl m0 text-grey w-80 md:w-full">
                                            Strive for continuous improvement and perseverance in your training and personal growth.
                                ...
                                <div class="benefits__item flex gap-4 md:gap-2">
                                    ...
                                    <div class="benefits__item__content flex-1">
                                        ...
                                        <p
                                            class="benefits__item__description text-xl m0 text-grey w-80 md:w-full">
                                            Show respect to instructors, peers, and opponents, fostering a sense of community and camaraderie.
                                ...
                                <div class="benefits__item flex gap-4 md:gap-2">
                                    ...
                                    <div class="benefits__item__content flex-1">
                                        ...
                                        <p
                                            class="benefits__item__description text-xl m0 text-grey w-80 md:w-full">
                                            Refrain from disrespectful and violent behavior - Use your skills responsibly and always aim to promote peace and harmony.

                                        </p>
{{--                                        <p--}}
{{--                                            class="benefits__item__description text-xl m0 text-grey w-80 md:w-full">--}}
{{--                                            Note that I have a deep understanding of philosophy and ethics.  Living in South Africa has been difficult at times due to a lack of understanding, especially in the disappointing track record and broken promises of the current dispensation.  Regardless, I am a South African and will always hope for peace and prosperity in my home country.  Thankfully, while I am prohibited from working in the country of my birth (as the ANC government implements reverse Apartheid) I am being offered opportunities to do contracting work globally which I am very thankful for.--}}
