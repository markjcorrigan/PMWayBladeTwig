                    ...
                    <?php $__currentLoopData = $testimonies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimony): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="testimonial-item">
                           <div class="top-area d-flex flex-wrap justify-content-between">
                              <div class="logo-box">
                                 <h4 class="name"> <?php echo e($testimony->name); ?> </h4>
                                 <span class="designation"><?php echo e($testimony->occupation); ?></span>
                              </div>
                              <div class="image-box">
                                 <img src="<?php echo e(asset($testimony->photo)); ?>" alt="" />
                              </div>
                           </div>
                           <div class="icon-box">
                           ...
                           <p class="quote">“<?php echo e($testimony->testimony); ?></p>
...
<?php /**PATH C:\xampp\htdocs\pmway\resources\views\frontend\partials\testimonial.blade.php ENDPATH**/ ?>