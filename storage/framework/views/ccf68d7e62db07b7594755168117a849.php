<div class="list-group">
    ...
    <a href="/profile/<?php echo e($follow->userBeingFollowed->name); ?>" class="list-group-item list-group-item-action">
        <img class="avatar-tiny" src="<?php echo e($follow->userBeingFollowed->avatar); ?>" />
        <?php echo e($follow->userBeingFollowed->name); ?>

    </a>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</div><?php /**PATH C:\xampp\htdocs\pmway\resources\views\profile-following-only.blade.php ENDPATH**/ ?>