      ...
      <div class="card">
        <div class="position-relative">
          <figure class="overflow-hidden mb-0 d-flex justify-content-center">
            <img src="<?php echo e(asset('../../../backend/assets/images/pbg.jpg')); ?>

            " class="rounded-top" alt="profile cover" style="width: 100%; height: 200px">
          </figure>
          <div class="d-flex justify-content-between align-items-center position-absolute top-90 w-100 px-2 px-md-4 mt-n4">
            <div>
              <img class="wd-70 rounded-circle" src="<?php echo e($admin->photo ? asset($admin->photo) : asset('uploads/no-img-avatar.png')); ?>" alt="profile">
              <span class="h4 ms-3 text-light"><?php echo e($admin->name); ?></span>
            </div>
            <div class="d-none d-md-block">
              <a href="<?php echo e(route('admin.edit.profile')); ?>" class="btn btn-primary btn-icon-text">
...
<?php echo $__env->make('admin.admin_dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pmway\resources\views\admin\pages\index.blade.php ENDPATH**/ ?>