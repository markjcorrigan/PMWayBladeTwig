<div class="m-auto w-1/2 mb-4">
    <h3 class="text-lg text-gray-200 mb-3">Edit Article (ID: <?php echo e($form->id); ?>)</h3>
        ...
        <div class="mb-3">
            ...
            <div class="flex items-center">
                ...
                <div class="text-center">
                    <?php if($form->photo): ?>
                        <img class="w-1/2 inline" src="<?php echo e($form->photo->temporaryUrl()); ?>">
                    <?php elseif($form->photo_path): ?>
                        <img class="w-1/2 inline" src="<?php echo e(Storage::url($form->photo_path)); ?>">
                        <div class="mt-2">
                            <button
                                type="button"
...
</div><?php /**PATH C:\xampp\htdocs\pmway\resources\views\livewire\edit-article.blade.php ENDPATH**/ ?>