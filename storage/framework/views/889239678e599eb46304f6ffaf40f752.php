...
<?php endif; ?>
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <ul class="pagination">
            <!--[if BLOCK]><![endif]--><?php if(!$posts->onFirstPage()): ?>
            <li class="page-item">
            ...
            <!--[if BLOCK]><![endif]--><?php for($i = 1; $i <= $posts->lastPage(); $i++): ?>
                <!--[if BLOCK]><![endif]--><?php if($i == $posts->currentPage()): ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($posts->hasMorePages()): ?>
                <li class="page-item">
...
<?php /**PATH C:\xampp\htdocs\pmway\resources\views/livewire/post-list.blade.php ENDPATH**/ ?>