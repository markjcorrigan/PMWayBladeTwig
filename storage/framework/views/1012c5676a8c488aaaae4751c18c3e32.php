    ...
    <div class="col-span-4 text-center">
        <p>
            <a href="/gamestats" target="_blanik">
                <img alt="Up Stat or Down Stat" class="w-full h-auto min-w-[300px]" src="/images/devopsimagemedium.png"
                    onmouseover="this.src='/images/devops2.gif'" onmouseout="this.src='/images/devopsimagemedium.png'"
...
<?php /**PATH C:\xampp\htdocs\pmway\resources\views\partials\footer.blade.php ENDPATH**/ ?>