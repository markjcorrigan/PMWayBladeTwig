<div x-data="{isOpen: false}">
  ...
  <div data-name="<?php echo e(auth()->user()->name); ?>" data-avatar="<?php echo e(auth()->user()->avatar); ?>" id="chat-wrapper"
    ...
    <div id="chat" class="chat-log">
      <?php if(count($chatLog) > 0): ?>
      <?php $__currentLoopData = $chatLog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php if(($chat['selfmessage'] ?? false) == true): ?>
      <div class="chat-self">
