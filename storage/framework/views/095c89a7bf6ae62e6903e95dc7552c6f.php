    ...
    <div class="search-overlay-bottom">
      <div class="container container--narrow py-3">
        ...
        <div class="live-search-results live-search-results--visible">
          ...
          <!--[if BLOCK]><![endif]--><?php if(count($results) == 0 && $searchTerm !== ""): ?>
          ...
          <div class="list-group shadow-sm">
            <div class="list-group-item active"><strong>Search Results</strong>
              ...
              (<?php echo e(count($results)); ?> <?php echo e(count($results) > 1 ? "results" : "result"); ?> found)

            </div>

            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a x-on:click.prevent="isOpen = false; Livewire.navigate('/post/<?php echo e($post->id); ?>')" href="/post/<?php echo e($post->id); ?>"
              class="list-group-item list-group-item-action">
              <img class="avatar-tiny" src="<?php echo e($post->user->avatar); ?>"> <strong><?php echo e($post->post_title); ?></strong>
              <span class="text-muted small">by <?php echo e($post->user->name); ?> on
                <?php echo e($post->created_at->format('n/j/Y')); ?></span>
            </a>
...
<?php /**PATH C:\xampp\htdocs\pmway\resources\views/livewire/search.blade.php ENDPATH**/ ?>