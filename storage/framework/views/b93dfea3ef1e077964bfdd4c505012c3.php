<div class="flex flex-col w-[500px] mx-auto py-16 p-4 bg-gray-100 rounded-lg shadow-md">
    ...
    <div class="py-6">
        ...
        <?php $__currentLoopData = $todos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $todo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php else: ?>
                <div class="flex gap-4 justify-between items-center py-2 border-b border-gray-200">
                    <input type="checkbox" <?php echo e($todo->completed ? ' checked' : ''); ?> wire:change="toggleTodo(<?php echo e($todo->id); ?>)" class="h-5 w-5 text-indigo-500 focus:ring-indigo-500 border-gray-300 rounded" >
                    <label class="flex-1 <?php echo e($todo->completed ? 'line-through text-gray-500' : 'text-gray-900'); ?> text-lg"><?php echo e($todo->todo); ?></label>
                    <div class="flex gap-2 justify-end">
                        <button wire:click="editTodo(<?php echo e($todo->id); ?>)" class="text-blue-500 hover:text-blue-700" >
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                            </svg>
                        </button>
                        <button wire:click="deleteTodo(<?php echo e($todo->id); ?>)" class="text-red-500 hover:text-red-700" >
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
</div><?php /**PATH C:\xampp\htdocs\pmway\resources\views\livewire\todo-list.blade.php ENDPATH**/ ?>