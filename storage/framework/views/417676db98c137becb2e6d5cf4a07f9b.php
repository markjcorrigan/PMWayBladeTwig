    ...
    <div class="container text-center">
        <div class="row">
            ...
            <br>at <!--<a href="/cmmi" title="Where are you at?  Click here for PMWay's 1 minute self assessment challenge.  We dare you to take the pin test now!" >-->CM Level 2<!--</a>--> and above</p>
					...
					<!--<img alt="Up Stat or Down Stat" class="img-fluid" src="/images/devopsimagemedium.png" title="How are your game stats?">-->
					<img alt="Up Stat or Down Stat" class="img-fluid" src="/images/devopsimagemedium.png" onmouseover="this.src='/images/devops2.gif'" onmouseout="this.src='/images/devopsimagemedium.png'" title="How are your game stats?  Click here for more"></a></p>
...
<?php /**PATH C:\xampp\htdocs\pmway\resources\views\legacy_footer.blade.php ENDPATH**/ ?>