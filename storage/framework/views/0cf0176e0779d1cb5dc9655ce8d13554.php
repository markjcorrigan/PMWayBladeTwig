...
<?php endif; ?>
            ...
            <a href="<?php echo e(route('home')); ?>" class="ml-2 mr-5 flex items-center space-x-2 lg:ml-0">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::navbar.item','data' => ['icon' => 'layout-grid','href' => ''.e(route('dashboard')).'','current' => request()->routeIs('dashboard')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => '/settings/profile','icon' => 'cog']); ?>Settings <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\pmway\resources\views\components\layouts\app\header.blade.php ENDPATH**/ ?>