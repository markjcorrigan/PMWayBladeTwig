<indexpage>
    ...
    <div class="container" align="center">
        ...
        <div class="rTableCell"><a href="/cmmi" title="On a Desktop drag the pin down to your Capability Maturity level now! Or drag the pin through the gateway and hit the Productivity and Quality improvement target!"><img id="pin" class="img-fluid" src="/images/pin40.png" alt="pin" /></a><img alt="" class="img-fluid" src="/images/gatewayflat.png" onmouseover="this.src='/images/gateway.png'" onmouseout="this.src='/images/gatewayflat.png'"><a href="/home/carousel?slide=5"><img id="target" class="img-fluid" title="Click the target for the project management and other processes to maintain and improve up to Capability Maturity Level 5" src="/images/targetsmall.png" alt="target" /></a></div>
        <div class="rTableCell"></div>
        </div>
        </div>
        </div>
                ...
                <div class="container">
                    <div class="card text-center">
                        ...
                        <div class="card-body text-center">
                            ...
                            <h3><b>Tired of the <a href="/homeviewpdf/resources/chaos-report.pdf" target="_blank">Chaos</a>?</b></h3>

                            <a href="/cmmi" title="Click the image to go to the Capability Maturity Model"><img class="img-fluid" src="/images/firstfive.png"></a>
                    ...
                    <a href="/home/agile">Agile processes</a>.<br>Then, <a href="/cmmi" target="_blank">with
                      ...
                      firmly in place</a>; reach higher. </h5>
                            ...
                            management processes found in the <a href="/pmway/?slide=1" target="_blank">PMBOK 6 dashboard</a>?<br>
                    ...
                    rapidly<br> &quot;Up Your Game Stats&quot; for CM L2+</h6>
                            ...
                            <a href="/home/gamestats" title="Click here for information about upping production statistics and red bead removal"><img alt="Red Beads" class="img-fluid" src="/images/redbeadsoutsmall.png"></a>
        ...
        <div class="rTableBody">
            ...
            <div class="collapse" id="collapseperformancestats">
                <div class="container">
                    <div class="card text-center">
                        <h3 class="card-header" align="center">The ITIL 4 Value Stream<br>Underpinned by Software Engineering with Lean, Devops, <a href="/pmway/?slide=1" target="_blank">TPM</a> or <a href="/home/agile" target="_blank">APM</a></h3>
                        ...
                        <div class="card-body text-center">
                            ...
                            <p>Do this for <a href="/pmway/?slide=1" target="_blank">Traditional Project Management processes</a> or
                                <a href="/home/agile">Agile processes</a>.<br>Then, <a href="/cmmi" target="_blank">with
                                    a managed CM Level 2 base
                                    firmly in place</a>; reach higher. </p>
                            <p><a href="/pmway/?slide=2" target="_blank">Connect the dots here</a> to see touchpoints on your journey towards success.</p>
            ...
            <div align="center">
                ...
                </button><a href="/pmway/?slide=5"><img id="target" class="img-fluid" title="Click the target for the project management and other processes to maintain and improve up to Capability Maturity Level 5" src="/images/targetsmall.png" alt="target" ></a>
                    ...
                    <div class="container">
                        <div class="card text-center">
                            <h5 class="card-header" align="center"><a href="/home/cmmi" target="_blank">Capability Maturity Level 2</a> is
                                ...
                                Else operating @ CM L1<!--<br><a href="/pmway/?slide=1" target="_blank"><em style="font-size:small">I.e. rush heroically into
PMBOK 6 process #4.3,<br>or <a href="/pmway/?slide=12" target="_blank">Scrum process #13</a><br>before receiving the tailored outputs required from the previous processes;
                                                    ...
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <p>Oh, also... do not forget that the PMBOK operates as a Standard!
                                                                ...
                                                                <br> as you <b>&quot;<a href="/pmway/?slide=2" target="_blank"><u>connect the dots</u></a>&quot;</b> below.</p>
                                                    ...
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <p><b>Planning</b> and <b>Monitoring and Control</b> on either side of <b>Execution</b> ensures delivery and ultimately accountability to Stakeholders.
                                                                ...
                                                                <br>on the <a href="/pmway/?slide=1" target="_blank"><u>PMBOK dashboard?</u></a>
...
-->
                                                    ...
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <p>The first step on your CMMi journey:
                                                                ...
                                                                <br>Then find these core processes <a href="/pmway/?slide=1" target="_blank">on the PMBOK 6 dashboard</a>!
                                                ...
                                                <div class="container">
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <br>
                                                            <br>
                                                            <p>Can you see how the image below ties back <a href="/pmway/?slide=1">to the PMBOK 6 dashboard</a>?</p><img alt="" class="img-fluid" src="/images/qualitymodels.png">
                                                        ...
                                                        <div class="card-body text-center">
                                                            <p align="left">Bidirectional Traceability of Requirements is at the heart of (Requirements Management [REQM] &amp; Configuration Management [CM]).
                                                                ...
                                                                <br>( <a href="/agileisdead" target="_blank">Latest agile thinking here agrees with this
                                                                    approach</a>)
                                                                <br>
                                                                <br>Finally, can you see that this side of the Gap is where you (software developers / <a href="/pmway/?slide=8" target="_blank">ITIL Service Designers</a>) are now.
                                                                ...
                                                                <br>After UAT sign off <a href="/pmway/?slide=8" target="_blank" title="Click here for information on SO in PMWay's ITIL page">Service Operations</a> must take over, maintaining the working system
                                                ...
                                                <div class="container">
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                                    ...
                                                                    <div class="card text-center">
                                                                        ...
                                                                        <div class="card-body text-left" align="left">
                                                                            ...
                                                                            <p align="left">Thanks Abhinav (page 294)
                                                                                <br> PS <a href="/pmway/?slide=10" target="_blank">I am reminded by the above of the importance of the Board
                                                            ...
                                                            <p>
                                                                <a href="/pmway/?slide=8"><img alt="dev ops is itil but faster!" class="img-fluid" src="/images/itilppsdevopsmodel.jpg" onmouseover="this.src='/images/itil.jpg'" onmouseout="this.src='/images/itilppsdevopsmodelsinglesource.jpg'" title="DevOps is ITIL, just empowered to be faster!"></a>
                                                            </p>
                                            ...
                                            Software Demo"</a> in <a href="/productincrement" target="_blank">product increments</a>!)</p>
                                                                          ...
                                                                          <div class="card text-center">
                                                                              ...
                                                                              <div class="card-body text-center">
                                                                                  ...
                                                                                  <p align="left">Can your sprints actually deliver (<a href="/release" target="_blank">release</a>) new versions of
                                                                                      ...
                                                                                      <a href="/pmway/?slide=1" target="_blank">per
                                                    ...
                                                    Master</a> and <a href="/homeviewpdf/resources/scrumteam.pdf" target="_blank" title="Thank you F. M. Fowler">Scrum Team</a>.</p>
                                                                                  ...
                                                                                  <div class="collapse" id="collapsereinventing">
                                                                                      <div class="container">
                                                                                          <div class="card text-center">
                                                                                              <h5 class="card-header" align="center">Discussed in the <a href="/pmway/?slide=8" target="_blank">ITIL page</a>, reiterated here due to its importance.</h5>
                                                                                              <div class="card-body text-left">
                                                                                                  ...
                                                                                                  <p align="left">The person who manages the entire release from end to end is the release manager and is still necessary. However, the release management role went from being a full-time position to a part-time one (statistically speaking), mainly because of the diminished work (thanks to automation). Capable release managers are
                                                                                                      ...
                                                                                                      <br>
                                                                                                      <p align="left">Thanks Abhinav (page 294)
                                                                                                          <br> PS <a href="/pmway/?slide=10" target="_blank">I am reminded by the above of PRINCE2 Agile</a></p>
                        ...
                        <div class="card-footer customcolorwhite">
                            <p align="center">
                                <a href="/pmway/?slide=2" target="_blank" title="Click here to position the dashboard in a greater scheme, &quot;connecting the dots&quot; below"><img alt="" class="img-fluid" src="/images/canyouconnectthedotssmall.png" ></a></p>
    ...
    <br>
    <br>
    <!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p align="center"><a href="https://pmway.hopto.org/itilfouroverview/index.html" target="_blank" title="need some ideas on how to do this?"><img alt="presentation icon" title="need some ideas on how to do this?" src="/images/presentationicon.png"></a><a href="/homeviewpdf/resources/itilfouroverview.pdf" target="_blank" title="view presentation in pdf"><img alt="presentation icon" title="view a summary of the above in pdf - note: full presentation is available if you are logged on" target src="/images/pdf-iconlarger.png"></a></p>-->
...
</indexpage><?php /**PATH C:\xampp\htdocs\pmway\resources\views\livewire\index.blade.php ENDPATH**/ ?>