...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" method="POST" action="<?php echo e(route('store.skill')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.admin_dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pmway\resources\views\backend\skills\add_skill.blade.php ENDPATH**/ ?>