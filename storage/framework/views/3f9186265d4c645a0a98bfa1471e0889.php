...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-header','data' => ['title' => ''.e(__('global.forgot_password')).'','description' => ''.e(__('global.forgot_password_description')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('global.forgot_password')).'','description' => ''.e(__('global.forgot_password_description')).'']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'email','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('global.email_address')),'type' => 'email','name' => 'email','required' => true,'autofocus' => true,'placeholder' => 'email@example.com']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','type' => 'submit','class' => 'w-full']); ?><?php echo e(__('global.send_password_reset_link')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div class="space-x-1 text-center text-sm text-zinc-400">
        <span><?php echo e(__('global.or_return_to')); ?></span>
...
</div><?php /**PATH C:\xampp\htdocs\pmway\resources\views\livewire\auth\forgot-password.blade.php ENDPATH**/ ?>