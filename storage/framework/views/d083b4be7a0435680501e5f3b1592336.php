    ...
    <tbody>
        <?php $__currentLoopData = $educations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td><?php echo e(Str::title($education->resume_title)); ?></td>
                <td><?php echo e(Str::title($education->institution)); ?></td>
                <td><?php echo e($education->from_year); ?></td>
                <td><?php echo e($education->to_year); ?></td>
                <td>
                    <a href="#" id="<?php echo e($education->id); ?>" data-bs-toggle="modal" data-bs-target="#EditExperienceModal"  class="btn btn-inverse-light editExp" style="margin-right: 10px;">Edit</a>
                    <a href="<?php echo e(route('delete.experience', [$education->id])); ?>" id="delete"  class="btn btn-inverse-danger">Delete</a>
                </td>
           </tr>
...
<?php echo $__env->make('admin.admin_dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pmway\resources\views\backend\resume\my_education.blade.php ENDPATH**/ ?>