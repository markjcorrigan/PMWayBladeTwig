...
{
    return $this->avatar ? $this->avatar->temporaryUrl() : asset('uploads/no_image.jpg');
}
    ...
    {
        $avatarPreview = $this->avatar ? $this->avatar->temporaryUrl() : asset('uploads/no_image.jpg');
        return view('livewire.avatarupload', ['avatarPreview' => $avatarPreview]);
    }
