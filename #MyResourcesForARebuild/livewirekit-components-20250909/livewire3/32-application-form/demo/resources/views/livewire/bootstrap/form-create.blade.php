    ...
    <form wire:submit="saveForm">
        <div class="card mt-4">
            ...
            <div class="card-body">
                    ...
                    @foreach ($questions as $index => $question)
                        <tr>
                            <td class="p-1" valign="top">
                                <select wire:model="templates.{{ $index }}" class="form-select">
                            ...
                            <td class="p-1" valign="top">
                                <button wire:click="removeQuestion({{ $index }})" type="button" class="btn btn-sm btn-danger">Delete</button>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                ...
                <div class="mt-3">
                    <button wire:click="addQuestion" type="button" class="btn btn-sm btn-primary">+ Add Question</button>
                </div>
