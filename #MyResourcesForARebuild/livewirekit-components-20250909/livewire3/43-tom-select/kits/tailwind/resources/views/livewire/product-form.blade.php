<div>
    <div class="mb-4">
        ...
        <input wire:model="name" id="name" type="text" class="mt-2 w-full rounded-lg border border-gray-400 py-2 pr-4 pl-2 text-sm focus:border-blue-400 focus:outline-none sm:text-base" required />
        @error('name')
    ...
    <div class="mb-4">
        ...
        <x-tom-select id="categories" wire:model="productCategories" options="categories" multiple />
