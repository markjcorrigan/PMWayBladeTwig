<div class="flex relative flex-wrap flex-1 items-stretch">
    ...
    <input type="text" placeholder="Search here..." wire:model.live.debounce="search" class="relative px-3 py-3 pl-10 w-full text-sm bg-white rounded border-0 shadow outline-none placeholder-blueGray-300 text-blueGray-600 focus:outline-none focus:ring" />
