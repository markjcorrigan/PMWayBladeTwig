<div x-data="{ 'showModal': false, 'selectedCategory': @entangle('selectedCategory') }" @keydown.escape="showModal = false">
    ...
    <button @click="showModal = true"
            ...
            @class(['bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded', 'opacity-50' => $bulkDisabled])
            >
        Bulk edit
    </button>
            ...
            <div class="flex flex-col items-start p-4">
                <div class="flex items-center w-full border-b pb-4">
                    ...
                    <svg @click="showModal = false"
                         class="ml-auto fill-current text-gray-700 w-6 h-6 cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
