            ...
            <form wire:submit="save" class="w-full">
                <div class="flex flex-col items-start p-4">
                    <div class="flex items-center w-full border-b pb-4">
                        ...
                        <svg wire:click="$toggle('showModal')" class="ml-auto fill-current text-gray-700 w-6 h-6 cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
                    ...
                    <div class="w-full mt-4">
                        ...
                        <input wire:model.defer="name" id="name"
                    ...
                    <div class="py-4 border-b w-full mb-4">
                        ...
                        <input wire:model.defer="price" id="price"
                               class="mt-2 text-sm sm:text-base pl-2 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400"/>
                        @error('price')
