<div class="position-fixed float-right bg-white w-25 h-100 px-1" style="right: 0">
    <div class="px-3 py-4">
                ...
                <tr>
                    ...
                    <td>
                        <div class="row d-inline-flex pl-3">
                             <span class="pr-1">
                                 <svg width="10px" wire:click="decreaseQuantity('{{ $item->id }}','{{ $item->qty }}')" viewBox="0 0 448 512">
                                    <path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z" />
                                </svg>
                             </span>
                            <input style="width: 25px" type="text" value="{{ $item->qty }}">
                            <span class="pl-1">
                                <svg width="10px" wire:click.live="increaseQuantity('{{ $item->id }}')" viewBox="0 0 448 512">
        ...
        <div class="pt-4 ">
            ...
            <select wire:model.live="selectedCountry" class="form-select form-control-sm">
        ...
        <div class="border-bottom pb-5">
            ...
            <select wire:model.live="shipping" class="form-select form-control-sm">
