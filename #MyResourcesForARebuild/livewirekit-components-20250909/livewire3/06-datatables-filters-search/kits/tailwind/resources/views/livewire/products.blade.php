<div>
    ...
    <table class="table min-w-full mb-4">
        <thead>
            <tr>
                <th wire:click.live="sortByColumn('name')" class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 tracking-wider">
                    Name
                    @if ($sortColumn == 'name')
                ...
                <th wire:click.live="sortByColumn('price')" class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 tracking-wider">
                    Price
                    @if ($sortColumn == 'price')
                        <i class="fa fa-fw fa-sort-{{ $sortDirection }}"></i>
                    @else
                ...
                <th wire:click.live="sortByColumn('description')" class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 tracking-wider">
                    Description
                ...
                <th wire:click.live="sortByColumn('category_name')" class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 tracking-wider">
                    Category
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-sm leading-5">
                    <input wire:model.live.debounce="searchColumns.description" type="text" placeholder="Search..."
                           class="mt-2 text-sm sm:text-base pl-2 pr-4 rounded-lg border border-gray-400 w-full py-1 focus:outline-none focus:border-blue-400" />
                </td>
                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-sm leading-5">
                    <select wire:model.live="searchColumns.product_category_id"
                            class="mt-2 text-sm sm:text-base pl-2 pr-4 rounded-lg border border-gray-400 w-full py-1 focus:outline-none focus:border-blue-400">
