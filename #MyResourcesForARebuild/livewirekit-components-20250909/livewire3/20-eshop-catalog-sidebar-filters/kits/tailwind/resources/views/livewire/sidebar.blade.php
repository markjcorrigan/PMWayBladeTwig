<div class="col-lg-3 mb-4">
    ...
    @foreach($categories as $index => $category)
        <div class="form-check">
            <input type="checkbox" id="category{{ $index }}" value="{{ $category->id }}" wire:model.live="selected.categories">
    ...
    @foreach($manufacturers as $index => $manufacturer)
        <div class="form-check">
            <input type="checkbox" id="manufacturer{{ $index }}" value="{{ $manufacturer->id }}" wire:model.live="selected.manufacturers">
