        ...
        <form wire:submit="save" class="w-full">
            <div class="flex flex-col items-start p-4">
                <div class="flex items-center w-full border-b pb-4 mb-4">
                    ...
                    <svg wire:click="closeModal" class="ml-auto fill-current text-gray-700 w-6 h-6 cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
                ...
                <div class="ml-auto mt-4">
                    ...
                    <button wire:click="toggleModal" class="bg-gray-500 text-white font-bold py-2 px-4 rounded" type="button">
                        Close
                    </button>
                </div>
            </div>
