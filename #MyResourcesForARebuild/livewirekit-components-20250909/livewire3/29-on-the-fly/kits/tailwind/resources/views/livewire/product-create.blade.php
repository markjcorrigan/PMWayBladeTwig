<div>
    ...
    <div class="mb-4">
        ...
        <input wire:model="product.name" type="text" id="name"
    ...
    <div class="mb-4">
        ...
        <div class="mt-2 flex justify-between">
            <div class="flex-1">
                <select name="category" wire:model="product.category" id="category"
            ...
            <div class="flex items-center ml-4">
                <a wire:click="$dispatch('toggleModal')" class="px-2 py-3 border border-gray-300 rounded text-xs cursor-pointer hover:shadow-md hover:border-blue-400">Add new category</a>
            </div>
        </div>
    </div>
