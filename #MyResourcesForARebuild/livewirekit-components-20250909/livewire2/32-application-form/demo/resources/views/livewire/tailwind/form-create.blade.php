    ...
    <form wire:submit.prevent="saveForm">
        ...
        <div class="mt-4 border border-gray-300 rounded-md">
            ...
            <div class="p-5">
                <table class="table table-auto w-full">
                    ...
                    @foreach ($questions as $index => $question)
                        <tr>
                            ...
                            <td class="p-1" valign="top">
                                <button wire:click.prevent="removeQuestion({{$index}})" class="hover:bg-red-600 ml-1 p-1 px-2 bg-red-500 border border-red-600 rounded-md text-white focus:outline-none">Delete</button>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                ...
                <div class="mt-3">
                    <button wire:click.prevent="addQuestion" class="hover:bg-indigo-600 p-1 px-4 bg-indigo-500 border border-indigo-600 rounded-md text-white focus:outline-none">+ Add Question</button>
                </div>
        ...
        <br/>
        <div>
            <input type="submit" value="Save Application Form" class="hover:bg-indigo-600 cursor-pointer p-1 px-4 bg-indigo-500 border border-indigo-600 rounded-md text-white focus:outline-none">
        </div>
    </form>
</div>
