<div class="d-flex position-relative flex-wrap flex-grow-1 align-content-stretch">
    <span style="z-index: 10;" class="position-absolute justify-content-center align-items-center py-2 pl-3 w-8 h-100">
    ...
    <input type="text" placeholder="Search here..." wire:model.debounce.300ms="search" class="flex-grow-1 position-relative px-3 py-2 pl-5 border" />
