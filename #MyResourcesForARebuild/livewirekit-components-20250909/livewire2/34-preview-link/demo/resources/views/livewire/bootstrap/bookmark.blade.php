<div>
    <form wire:submit.prevent="storeBookmark">
        <div class="form-group row">
            <label class="col-md-4 col-form-label text-md-right" for="title">
                Link
            </label>
            <div class="col-md-6">
                <input wire:model.debounce.500ms="link" type="text" placeholder="https://" class="form-control @error('link') is-invalid @enderror"/>
                @error('link')
