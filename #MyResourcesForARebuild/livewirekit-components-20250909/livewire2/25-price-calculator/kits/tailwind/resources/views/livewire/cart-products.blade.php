<div class="fixed right-80 -mx-80 w-1/4 bg-white border-l-2 h-full block px-2  ">
    <div class="bg-white pl-3 pr-5 py-10">
        ...
        @foreach($cartItems as $item)
            <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                ...
                <div class="flex justify-center w-1/5">
                    ...
                    <svg wire:click="increaseQuantity('{{$item->id}}')" class="fill-current text-gray-600 w-3"
                         viewBox="0 0 448 512">
        ...
        <div>
            ...
            <select wire:model='selectedCountry' class="block p-2 text-gray-600 w-full text-sm">
        ...
        <div>
            ...
            <select wire:model="shipping" class="block p-2 text-gray-600 w-full text-sm">
