<div>
    ...
    <form wire:submit.prevent="saveTournament" class="border-b-2 pb-10">
        <div>
            <label class="block font-medium text-sm text-gray-700" for="name">
                Tournament name
            </label>
            <input wire:model="tournamentName" class="mt-2 text-sm sm:text-base pl-2 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" required>
        </div>
