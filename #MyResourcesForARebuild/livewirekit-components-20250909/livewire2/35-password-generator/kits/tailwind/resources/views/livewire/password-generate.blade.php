    ...
    <div>
        ...
        <div class="grid grid-cols-5 gap-2">
            <div class="relative mt-2 col-span-4">
                ...
                <button type="button" @class(['absolute inset-y-0 right-0 pr-3 flex items-center', 'hidden' => $visible]) wire:click="$toggle('visible')">
                ...
                <button @class(['absolute inset-y-0 right-0 pr-3 flex items-center', 'hidden' => ! $visible]) wire:click="$toggle('visible')">
